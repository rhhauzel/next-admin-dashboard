    ...
    return (
        <form action={formAction}>
            <div className="rounded-md p-4 md:p-6">
                {/* Customer Name */}
                <div className="mb-4">
                    <label htmlFor="customer" className="mb-2 block text-sm from-medium">
                        Choose customer
                    </label>
                    <div className="relative">
                        ...
                        <UserCircleIcon className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 h-[18px] w-[18px]" />
                    </div>
